...
namespace ZmeykaGame
{
    ...
    internal class Program
    {
        ...
        private static void Draw()
        {
            ...
            {
                new string(' ', _size.Width - 2).Write(1, i, ConsoleColor.Black, ConsoleColor.Black);
            }
            ...
            $"Очки: {_tail.Count()}".Write(_size.Width + 10, 10);
        }
        ...
        {
            $"Вы проиграли".Write(_size.Width + 3, 3, ConsoleColor.Red, ConsoleColor.White);
            $"Нажмите пробел чтобы начать заново".Write(_size.Width + 3, 4, ConsoleColor.Black, ConsoleColor.Gray);
